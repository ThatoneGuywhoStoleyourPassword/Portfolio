...
export const AnimatedBorderButton = ( { children }) => {
    return  <button className=" relative bg-transparent border border-border text-foreground
    ...
    group px-8 py-4 text-lg font-medium rounded-full overflow-visible animated-border">
                    ...
                    >
                        <path
                        d="M 30,1 A29, 29 0 0 0 1, 30 L 1, 30 A29,
                         29 0 0 0 30, 59 L 170, 59 A29, 29 0 0 0 199, 30 L 199, 30 A29, 29 0 0 0 170,1 Z"
                        fill="none"
